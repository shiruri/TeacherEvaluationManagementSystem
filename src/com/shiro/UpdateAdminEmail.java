...
import java.sql.Statement;
		...
		public class UpdateAdminEmail  implements UpdateStrategy{ 
		static Connection con = null;
		static Statement stmt = null;
		static GetAdminList ls = new GetAdminList();

		@Override
		public void Update(String id, String newData) throws SQLException {
			...
			String sqlUpdateAdminName = "update admin set adminEmail = ? where adminId = ?";
